...
<div class="row" style="margin-top: 20px">
    ...
    <div style="width: 50%">
        <form class="form-horizontal" role="form" action=<?php echo U("goods/index/post_add_goods");?> method="post">
            ...
            <div class="form-group">
                ...
                <div class="col-sm-10">
                    <select class="form-control" name="gid">
                        <?php if(is_array($glist)): $i = 0; $__LIST__ = $glist;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i;?><option value="<?php echo ($v["id"]); ?>">
                            <?php $__FOR_START_1459026918__=1;$__FOR_END_1459026918__=$v['count'];for($i=$__FOR_START_1459026918__;$i < $__FOR_END_1459026918__;$i+=1){ ?>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<?php } ?>
                            <?php echo ($v["name"]); ?>
            ...
            <div class="form-group">
                ...
                <div class="col-sm-10">
                    <input type="text" class="form-control" name="logo" placeholder="品牌">
                </div>
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
                ...
                <div class="col-sm-10">
                    <input type="text" class="form-control" name="place" placeholder="如中国">
                </div>
            </div>
            <div class="form-group">
                <label class="col-sm-2 control-label">尺寸</label>
                <div class="col-sm-10">
                    <input type="text" class="form-control" name="size" placeholder="**英寸">
                </div>
            </div>
            <div class="form-group">
                <label class="col-sm-2 control-label">处理器</label>
                <div class="col-sm-10">
                    <input type="text" class="form-control" name="cpu" placeholder="处理器型号">
                </div>
            </div>
            <div class="form-group">
                ...
                <div class="col-sm-10">
                    <select class="form-control" name="touch">
                        <option value="触控">触控</option>
                        <option value="非触控">非触控</option>
                    </select>
                </div>
            </div>
            <div class="form-group">
                ...
                <div class="col-sm-10">
                    <select class="form-control" name="t">
                        <option value="轻薄">轻薄</option>
                        <option value="普通轻薄">普通轻薄</option>
                        <option value="非轻薄">非轻薄</option>
                    </select>
                </div>
            </div>
            <div class="form-group">
                ...
                <div class="col-sm-10">
                    <label class="radio-inline">
                        <input type="radio" name="shelve"  value="1">是
                    </label>
                    <label class="radio-inline">
                        <input type="radio" name="shelve" id="0" value="option2">否
                    </label>
                </div>
            </div>
            <div class="form-group">
                ...
                <div class="col-sm-10">
                    <label class="radio-inline">
                        <input type="radio" name="cp" id="inlineRadio1" value="1">是
                    </label>
                    <label class="radio-inline">
                        <input type="radio" name="cp" id="inlineRadio2" value="0">否
                    </label>
                </div>
            </div>
            <div class="form-group">
                ...
                <div class="col-sm-10">
                    <input type="text" id="thumb" class="span5" name="thumb">
