...
<div class="row" style="margin-top: 20px">
    ...
    <form action=<?php echo U("goods/index/post_edit_goods_cate","id=$e_g_c[id]");?> method="post">
            ...
            <div role="tabpanel" class="tab-pane active" id="home">
                <table class="table table-hover">
                    <tr>
                        ...
                        <td>
                            <select class="form-control" name="pid">
                                ...
                                <?php if(is_array($glist)): $i = 0; $__LIST__ = $glist;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><option value="<?php echo ($vo["id"]); ?>" <?php if(($e_g_c["pid"]) == $vo["id"]): ?>selected<?php endif; ?>>
                                        <?php $__FOR_START_2119599543__=1;$__FOR_END_2119599543__=$vo['count'];for($i=$__FOR_START_2119599543__;$i < $__FOR_END_2119599543__;$i+=1){ ?>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<?php } ?>
                                        <?php echo ($vo["name"]); ?>
                    ...
                    <tr>
                        <td>名称</td>
                        <td>
                            <input type="text" class="form-control" value=<?php echo ($e_g_c["name"]); ?> name="name">
                        </td>
                    </tr>
                </table>
