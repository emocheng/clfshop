...
<div class="row" style="margin-top: 20px">
    ...
    <button type="button" class=" btn btn-primary">
        <a href=<?php echo U("goods/index/add_goods");?> style="color: #fff">添加商品</a>
    </button>
    <div class="panel panel-default" style="margin-top: 20px;">
        ...
        <div class="panel-body">
            <table class="table table-bordered">
                ...
                <tbody>
                <?php if(is_array($eg)): $i = 0; $__LIST__ = $eg;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i;?><tr>
                        ...
                        <td>
                            <?php if(($v["shelve"]) == "1"): ?><span class="glyphicon glyphicon-ok"></span>
                                <?php else: ?>
                                <span class="glyphicon glyphicon-remove"></span><?php endif; ?>
                        </td>
                        <td>
                            <?php if(($v["cp"]) == "1"): ?><span class="glyphicon glyphicon-ok"></span>
                                <?php else: ?>
                                <span class="glyphicon glyphicon-remove"></span><?php endif; ?>
                        </td>
                        <td>99</td>
                        <td>44</td>
                        <td><a href=<?php echo U("goods/index/edit_goods","id=$v[id]");?>><span class="glyphicon glyphicon-pencil"></span></a>
                            <a href=<?php echo U("goods/index/del_goods","id=$v[id]");?>><span class="glyphicon glyphicon-trash"></span></a>
