...
<div class="row" style="margin-top: 20px">
    ...
    <div style="width: 50%">
        <form class="form-horizontal" role="form" action=<?php echo U("goods/index/post_edit_goods","id=$e[id]");?> method="post">
            ...
            <div class="form-group">
                ...
                <div class="col-sm-10">
                    <input type="text" class="form-control" name="sn" value="<?php echo ($e["sn"]); ?>">
                </div>
            </div>
            <div class="form-group">
                <label class="col-sm-2 control-label">价格</label>
                <div class="col-sm-10">
                    <input type="text" class="form-control" name="price" value="<?php echo ($e["price"]); ?>">
                </div>
            </div>
            <div class="form-group">
                ...
                <div class="col-sm-10">
                    <select class="form-control" name="gid">
                        <?php if(is_array($glist)): $i = 0; $__LIST__ = $glist;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i;?><option value="<?php echo ($v["id"]); ?>" <?php if(($e["gid"]) == $v["id"]): ?>selected<?php endif; ?> >
                                <?php $__FOR_START_1966238695__=1;$__FOR_END_1966238695__=$v['count'];for($i=$__FOR_START_1966238695__;$i < $__FOR_END_1966238695__;$i+=1){ ?>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<?php } ?>
                                <?php echo ($v["name"]); ?>
            ...
            <div class="form-group">
                ...
                <div class="col-sm-10">
                    <input type="text" class="form-control" name="logo" value="<?php echo ($e["logo"]); ?>">
                </div>
            </div>
            <div class="form-group">
                <label class="col-sm-2 control-label">商品毛重</label>
                <div class="col-sm-10">
                    <input type="text" class="form-control" name="weight" value="<?php echo ($e["weight"]); ?>">
                </div>
            </div>
            <div class="form-group">
                <label class="col-sm-2 control-label">商品产地</label>
                <div class="col-sm-10">
                    <input type="text" class="form-control" name="place" value="<?php echo ($e["place"]); ?>">
                </div>
            </div>
            <div class="form-group">
                <label class="col-sm-2 control-label">尺寸</label>
                <div class="col-sm-10">
                    <input type="text" class="form-control" name="size" value="<?php echo ($e["size"]); ?>">
                </div>
            </div>
            <div class="form-group">
                <label class="col-sm-2 control-label">处理器</label>
                <div class="col-sm-10">
                    <input type="text" class="form-control" name="cpu" value="<?php echo ($e["cpu"]); ?>">
                </div>
            </div>
            <div class="form-group">
                <label class="col-sm-2 control-label">触控</label>
                <div class="col-sm-10">
                    <select class="form-control" name="touch">
                        <option <?php if(($e["touch"]) == "触控"): ?>selected<?php endif; ?> value="触控">触控</option>
                        <option <?php if(($e["touch"]) == "非触控"): ?>selected<?php endif; ?> value="非触控">非触控</option>
                    </select>
                </div>
            </div>
            <div class="form-group">
                ...
                <div class="col-sm-10">
                    <select class="form-control" name="t">
                        <option <?php if(($e["t"]) == "轻薄"): ?>selected<?php endif; ?> value="轻薄">轻薄</option>
                        <option <?php if(($e["t"]) == "普通轻薄"): ?>selected<?php endif; ?> value="普通轻薄">普通轻薄</option>
                        <option <?php if(($e["t"]) == "非轻薄"): ?>selected<?php endif; ?> value="非轻薄">非轻薄</option>
                    </select>
                </div>
            </div>
            <div class="form-group">
                ...
                <div class="col-sm-10">
                    <label class="radio-inline">
                        <input type="radio"  name="shelve" value="1" <?php if(($e["shelve"]) == "1"): ?>checked<?php endif; ?>>是
                    </label>
                    <label class="radio-inline">
                        <input type="radio"  name="shelve" value="0" <?php if(($e["shelve"]) == "0"): ?>checked<?php endif; ?>>否
                    </label>
                </div>
            </div>
            <div class="form-group">
                ...
                <div class="col-sm-10">
                    <label class="radio-inline">
                        <input type="radio" name="cp"  value="1" <?php if(($e["shelve"]) == "1"): ?>checked<?php endif; ?>>是
                    </label>
                    <label class="radio-inline">
                        <input type="radio" name="cp"  value="0" <?php if(($e["shelve"]) == "1"): ?>checked<?php endif; ?>>否
                    </label>
                </div>
            </div>
            <div class="form-group">
                ...
                <div class="col-sm-10">
                    <input type="text" id="thumb" class="span5" name="thumb" value="<?php echo ($e["thumb"]); ?>">
