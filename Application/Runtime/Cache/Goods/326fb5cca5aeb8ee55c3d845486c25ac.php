...
<div class="row" style="margin-top: 20px">
    ...
    <a href=<?php echo U("goods/index/add_goods_cate");?>>
        ...
        <div class="panel-body">
            <table class="table table-bordered">
                ...
                <?php if(is_array($glist)): $i = 0; $__LIST__ = $glist;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i;?><tr>
                        ...
                        <td><a href=<?php echo U("goods/index/edit_goods_cate","id=$v[id]");?>><span class="glyphicon glyphicon-pencil"></span></a>
                            <a href=<?php echo U("goods/index/del_goods_cate","id=$v[id]");?>><span class="glyphicon glyphicon-trash"></span></a>
