...
<div class="row" style="margin-top: 20px">
    ...
    <a href=<?php echo U("article/index/add_assortment");?>><button type="button" class="btn btn-primary">新增分类</button></a>
        ...
        <div class="panel-body">
            <table class="table table-bordered">
                ...
                <?php if(is_array($alist)): $i = 0; $__LIST__ = $alist;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
                        ...
                        <td>
                            <?php $__FOR_START_1557502099__=1;$__FOR_END_1557502099__=$vo['count'];for($i=$__FOR_START_1557502099__;$i < $__FOR_END_1557502099__;$i+=1){ ?>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<?php } ?>
                            <?php echo ($vo["name"]); ?>
                        </td>
                        <td><a href=<?php echo U("article/index/edit_column","id=$vo[id]");?>><span class="glyphicon glyphicon-pencil"></span></a>
                            <a href=<?php echo U("article/index/del_column","id=$vo[id]");?>><span class="glyphicon glyphicon-trash"></span></a>
