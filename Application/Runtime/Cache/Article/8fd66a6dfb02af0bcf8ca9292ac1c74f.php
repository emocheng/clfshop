...
<div class="row" style="margin-top: 20px">
    ...
    <div class="panel panel-default" style="margin-top: 20px;">
        ...
        <div class="panel-body">
            <!-- Tab panes -->
            <form action=<?php echo U("article/index/post_column");?> method="post">
                        ...
                        <table class="table table-hover">
                                ...
                                <td>
                                    <select class="form-control" name="pid">
                                        ...
                                        <?php if(is_array($alist)): $i = 0; $__LIST__ = $alist;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><option value="<?php echo ($vo["id"]); ?>">
                                                <?php $__FOR_START_1368619971__=1;$__FOR_END_1368619971__=$vo['count'];for($i=$__FOR_START_1368619971__;$i < $__FOR_END_1368619971__;$i+=1){ ?>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<?php } ?>
                                                <?php echo ($vo["name"]); ?>
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <div class="radio">
                                        <label>
                                            <input type="radio" name="type" id="optionsRadios3" value="2" checked>
                                            URL跳转
                                        </label>
                                    </div>
                                </td>
