...
<div class="row" style="margin-top: 20px">
    ...
    <form class="form-horizontal" role="form" action=<?php echo U("article/index/post_edit_article","id=$a[id]");?> method="post">
        <div class="form-group">
            <label class="col-sm-2 control-label">文章标题:</label>
            <div class="col-sm-10">
                <input type="text" name="title" class="form-control" value=<?php echo ($a["title"]); ?>>
            </div>
        </div>
        <div class="form-group">
            ...
            <div class="col-sm-10">
                <select class="form-control" name="cid">
                    <?php if(is_array($alist)): $i = 0; $__LIST__ = $alist;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><option value="<?php echo ($vo["id"]); ?>" <?php if(($a["cid"]) == $vo["id"]): ?>selected<?php endif; ?>>
                            <?php $__FOR_START_2125326389__=1;$__FOR_END_2125326389__=$vo['count'];for($i=$__FOR_START_2125326389__;$i < $__FOR_END_2125326389__;$i+=1){ ?>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<?php } ?>
                            <?php echo ($vo["name"]); ?>
        ...
        <div class="form-group">
            ...
            <div class="col-sm-10">
                <textarea name="content" class="content"><?php echo ($a["content"]); ?></textarea>
            </div>
        </div>
        <div class="form-group">
