...
<div class="row" style="margin-top: 20px">
    ...
    <a href=<?php echo U("article/index/add_article");?>><button type="button" class="btn btn-primary">新增文章</button></a>
    ...
    <div class="panel panel-default" style="margin-top: 20px;">
        ...
        <div class="panel-body">
            <table class="table table-bordered">
                ...
                <tbody>
                <?php if(is_array($art)): $i = 0; $__LIST__ = $art;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
                        <td><input type="checkbox" value=""></td>
                        <td><?php echo ($vo["title"]); ?></td>
                        <td><?php echo ($vo["cate_name"]); ?></td>
                        <td><?php echo (date("Y-m-d H:i:s",$vo["time"])); ?></td>
                        <td><a href=<?php echo U("article/index/edit_article","id=$vo[id]");?>><span class="glyphicon glyphicon-pencil"></span></a>
                            <a href=<?php echo U("article/index/del_article","id=$vo[id]");?>><span class="glyphicon glyphicon-trash"></span></a>
                        </td>
