    ...
    <div class="panel panel-default" style="margin-top: 20px;">
        ...
        <div class="panel-body">
            <table class="table table-bordered">
                <thead>
                <tr>
                    <th><input type="checkbox" value="">编号</th>
                    <th>会员姓名</th>
                    <th>留言标题</th>
                    <th>类型</th>
                    <th>留言时间</th>
                ...
                <tbody>
                <tr>
                    <?php if(is_array($m)): $i = 0; $__LIST__ = $m;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i;?><td><input type="checkbox" value=""><?php echo ($v["id"]); ?></td>
                        ...
                        <td><a href=""><span class="glyphicon glyphicon-zoom-in"></span></a>
                            <a href=<?php echo U("vip/index/del_massage","id=$v[id]");?>><span class="glyphicon glyphicon-trash"></span></a>
