    ...
    <div class="panel panel-default" style="margin-top: 20px;">
        ...
        <div class="panel-body">
            <table class="table table-bordered">
                ...
                <tbody>
                <?php if(is_array($u)): $i = 0; $__LIST__ = $u;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i;?><tr>
                        <td><input type="checkbox" value=""></td>
                        <td><?php echo ($v["name"]); ?></td>
                        <td><?php echo ($v["password"]); ?></td>
                        <td><?php echo ($v["level_name"]); ?></td>
                        <td><a href=<?php echo U("vip/index/edit_vip","id=$v[id]");?>><span class="glyphicon glyphicon-pencil"></span></a>
                            <a href=<?php echo U("vip/index/del_vip","id=$v[id]");?>><span class="glyphicon glyphicon-trash"></span></a>
                        </td>
