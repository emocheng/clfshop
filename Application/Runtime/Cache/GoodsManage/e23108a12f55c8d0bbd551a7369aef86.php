            ...
            <div class="panel panel-default">
                ...
                <div id="collapseOne" class="panel-collapse collapse in" role="tabpanel" aria-labelledby="headingOne">
                    <div class="list-group">
                        <a href=<?php echo U("goodsmanage/index/index");?> class="list-group-item list-group-item-success">文章分类</a>
                        <a href=<?php echo U("goodsmanage/index/articlelist");?> class="list-group-item list-group-item-info">文章列表</a>
                    </div>
                </div>
            </div>
            <div class="panel panel-default">
        ...
        <div class="panel-body">
            <table class="table table-bordered">
                ...
                <tr>
                    ...
                    <td>第一篇文章啊实打实大师的撒打算打算水电费水电费第三方第三方士大夫</td>
                    <td>栏目一</td>
                    <td>2014-11-23</td>
