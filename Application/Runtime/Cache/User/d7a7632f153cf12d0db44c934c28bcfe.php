    ...
    <div class="welcome_user">
        <div class="user_info">
            <div class="user_info_img">
                <img src="/Public/img/admin_03.gif" width="50" height="50">
            </div>
        ...
        <div class="user_pay">
            <p>余额:<span><?php echo ($sum); ?></span></p>
            <p>积分:<span>100</span></p>
            <p>等级:<span><?php echo ($u_f["level_name"]); ?></span></p>
        </div>
    </div>
    <div class="clear"></div>
    <div class="user_view">
        ...
        <div class="view_pc">
            <ul>
                <li><a href=""><img src="/Public/img/user_06.gif"/></a></li>
                <li>
                    <a href="">
                        <img src="/Public/img/user_03.gif"/>
                        <p>￥3599.00</p>
                    </a>
                </li>
                <li>
                ...
                <li><a href=""><img src="/Public/img/user_09.gif"/></a></li>
            </ul>
        </div>
    </div>
