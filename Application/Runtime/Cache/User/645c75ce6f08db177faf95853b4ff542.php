...
<div class="main">
    ...
    <div class="address">
        <p>收货地址</p>
        <?php if(is_array($my_address)): $i = 0; $__LIST__ = $my_address;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i;?><div class="my_address_bord">
                <h3><span><?php echo ($v["username"]); ?></span>
                    <a href="">修改地址信息</a>
                    <a href=<?php echo U("user/index/del_address","id=$v[id]");?>>删除</a></h3>
                <h4>收货人:<span><?php echo ($v["username"]); ?></span></h4>
                <h4>地址:<span><?php echo ($v["address"]); ?></span></h4>
                <h4>手机:<span><?php echo ($v["userphone"]); ?></span></h4>
            </div><?php endforeach; endif; else: echo "" ;endif; ?>
        <div class="add_address">
            <p>新增收货地址</p>
            <div class="add_my_address">
                <form action=<?php echo U("user/index/post_address");?> method="post">
                    <table class="add_m_a_table">
                        ...
                        <tr>
                            <td></td>
                            <td><input type="checkbox" name="type" value="1"/>设为默认收货地址</td>
                        </tr>
                    </table>
                    <input class="new_address_btn" type="submit" value="保存"/>
                </form>
            </div>
        </div>
    </div>
