...
<div class="main">
    ...
    <div class="user_goods">
        ...
        <?php if(is_array($ac)): $i = 0; $__LIST__ = $ac;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i;?><table class="my_goods">
                <tr>
                    <td>
        ...
        <div class="my_address_bord">
            <h3><span><?php echo ($ad["username"]); ?></span>
                <a href="">修改地址信息</a>
            </h3>
            <h4>收货人:<span><?php echo ($ad["username"]); ?></span></h4>
            <h4>地址:<span><?php echo ($ad["address"]); ?></span></h4>
            <h4>手机:<span><?php echo ($ad["userphone"]); ?></span></h4>
        </div>
        <hr style="border:0;background-color:#ddd;height:1px;"/>
        <div class="pay_ready">
            <p>应付金额:<span><?php echo ($pay_sum); ?></span></p>
            <p>您的余额:<span><?php echo ($my_money_sum); ?></span></p>
        </div>
        <div class="pay">
    ...
    <script>
        $(function(){
            $(".pay_ok").click(function(){
                var pay_sum = <?php echo ($pay_sum); ?>;//定义应付金额
                var my_money= <?php echo ($my_money_sum); ?>; //定义自己的余额
