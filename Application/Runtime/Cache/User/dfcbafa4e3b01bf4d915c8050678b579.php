...
<div class="main">
    ...
    <div class="car">
        ...
        <div class="clear"></div>
        <?php if(is_array($c)): $i = 0; $__LIST__ = $c;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i;?><table class="my_car">
                <tr>
                    <td>
                        <input class="check" type="checkbox"/>
                        <img src="<?php echo ($v["thumb"]); ?>.gif" width="99" height="68">
                    </td>
                    <td><a href=<?php echo U("home/index/goods","id=$v[gid]");?>><?php echo ($v["name"]); ?></a></td>
                    <td>￥<span><?php echo ($v["price"]); ?></span></td>
                    <td>
                        <a class="btn-add" href="javascript:;" type="<?php echo ($v["gid"]); ?>">+</a>
                        <input class="text" id="buy-num" value="<?php echo ($v["count"]); ?>">
                        <a class="btn-reduce" href="javascript:;" type="<?php echo ($v["gid"]); ?>">-</a>
                    </td>
                    <td><a href="">删除</a>|<a href="">收藏</a></d>
                </tr>
            </table><?php endforeach; endif; else: echo "" ;endif; ?>
        <div class="sum_car">
            <span class="sum_count"><?php echo ($sum_count); ?></span>件商品&nbsp&nbsp&nbsp&nbsp总计:￥<span class="sum_money"><?php echo ($sum_money); ?></span>
            <br/>
            <a href=<?php echo U("user/index/account");?>><input class="submit" type="submit" value="去结算" <?php if(($c) == ""): ?>disabled<?php endif; ?>/></a>
        </div>
    </div>
        <script>
            $(function(){
